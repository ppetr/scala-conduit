...
trait Runner {
  ...
  def runPipe[R](pipe: Pipe.NoInput[Nothing,R]): R =
    runPipe[Nothing,R](pipe, NullIO)

  def runPipe[O,R](pipe: Pipe.NoInput[O,R], sender: O => Unit): R =
    runPipe[Nothing,O,R](pipe, NullIO, sender)
  def runPipe[I,O,R](pipe: Pipe[I,O,R], receiver: () => Option[I], sender: O => Unit): R;
}
